...
<div class="header">
    ...
    {{-- <div class="header-left flex items-center space-x-4">
        @php
            $logoPath = asset('storage/' . AppSettings::get('logo'));
            $defaultLogoPath = asset('assets/img/pharrrlg.png');
            $smallLogoPath = asset('assets/img/logo-small.png');
        @endphp
        ...
        @elseif(file_exists(public_path($defaultLogoPath)))
            <a href="{{ route('dashboard') }}" class="logo">
                <img src="{{ $defaultLogoPath }}" alt="Logo" class="h-10">
            </a>
        @else
            <p class="text-sm text-gray-500">Logo not found.</p>
        @endif

        <a href="{{ route('dashboard') }}" class="logo logo-small">
            <img src="{{ $smallLogoPath }}" alt="Logo" class="h-7 w-7">
        </a>
    </div> --}}
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <p class="noti-details">
                                                <span class="noti-title">{{ $notification->data['product_name'] }} is
                                                    only {{ $notification->data['quantity'] }} left.</span>
